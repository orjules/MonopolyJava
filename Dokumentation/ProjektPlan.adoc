...
- Erste Testgetriebene Implementierung der neuen Architektur mit vielversprechenden Erfolgen

=== 17.4.21

- Weitere States implementiert und einen ersten Versuch für den Presenter erstellt
